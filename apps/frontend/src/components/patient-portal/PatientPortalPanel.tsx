...
const languageOptions: Array<[PortalResponseLanguage, string]> = [
  ["auto", "Auto"],
  ["en-US", "English"],
  ["bn-BD", "Bangla"],
  ["hi-IN", "Hindi"],
...
export function PatientPortalPanel({
  ...
  const [responseLanguage, setResponseLanguage] =
    useState<PortalResponseLanguage>("auto");
        ...
        <div className="portal-invite-grid">
          ...
          <label>
            ...
            <select
              ...
              onChange={(event) =>
                setResponseLanguage(event.target.value as PortalResponseLanguage)
              }
            >
